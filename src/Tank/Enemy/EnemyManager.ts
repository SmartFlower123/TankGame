class EnemyManager {
	...
	/**创建 */
	public createItem(_comParent: fairygui.GComponent, spriteOrder: number, identity: Identity=Identity.ENEMY, startPos?: egret.Point, resName: string = "Player1_01", anthor: egret.Point = new egret.Point(0.56, 0.08)): GameEnemy {//createItem
